...
Ajax_upload = AjaxUpload = function(button, options){
	...
	//TODO 3
	this._parentDialog = $('#progress').find('#fileUpload')[0]//d.body;
	...
	this._settings = {
		...
		onSubmit: function(file, fileSize, extension){},
		// Fired when file upload is completed
		// WARNING! DO NOT USE "FALSE" STRING AS A RESPONSE!
		onComplete: function(file, fileSize, response) {}
	};
...
AjaxUpload.prototype = {
	...
	_createInput : function(){
		...
		//$('#progress').find('#myModalLabel').append(input)
...
//	        fileSize = aa.GetFile(filepath).size; 
			...
			fileSize = this._input.files[0].size;   
		}else{
			fileSize = this._input.files[0].size;   
	    }
		
		// execute user event
		if (! (settings.onSubmit.call(this, file,fileSize ,getExt(file)) == false)) {
...
/*				// fixing Opera 9.26
				...
				settings.onComplete.call(self, file,fileSize,response);
