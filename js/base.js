 ...
 * update 2017-5-8
 * + Array.prototype.map 兼容IE8
 * update 2017-5-19
 * + merge: 参数通过自执行传递, 返回值直接接
 * update 2017-7-11
...
//检查元素是否存在于数组中,基于indexOf
if(!Array.prototype.isExist){Array.prototype.isExist=function(v){return this.indexOf(v)!=-1};}
//数组去重
if(!Array.prototype.unique){Array.prototype.unique=function(){var arr=this,len=this.length,ret=[],hash={};for(var i=0;i<len;i++){var v=arr[i];if(!hash[v]){hash[v]=1;ret.push(v)}}return ret};}
//计算字节数
...
var a = isEmpty('');//true
var b = isEmpty(' ');//true
var b = isEmpty(' ', true);//false
var c = isEmpty(null);//true
var d = isEmpty(undefined);//true
var i = isEmpty([]);//true
var j = isEmpty({});//true
var e = isEmpty(0);//false
var h = isEmpty(1);//false
var f = isEmpty(false);//false
var g = isEmpty('str');//false
var x = isEmpty([1,2]);//false
var y = isEmpty({a:1, b:'2'});//false
console.log('\'\'=',a)
console.log('\' \'=',b)
console.log('null=',c)
...
var isEmpty = function(value, allowEmptyString){
	...
	//0 ; false
	var isNumOrBool = function(value){
...
var range2border = function(dom, top){
